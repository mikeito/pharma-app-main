...
export const TagList: React.FC<TagListProps> = ({ tags, customTagRenderer, direction, draggable, onSortEnd, ...tagListProps }) => {
  ...
  return (
    ...
    >
      {draggable ? (
        ...
        tags.map((tagObj) => (customTagRenderer ? customTagRenderer(tagObj) : <Tag key={tagObj.id} tagObj={tagObj} {...tagListProps} />))
      )}
    </div>
  );
};
